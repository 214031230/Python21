...
def depart_add(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'depart_add.html', {'form': form, "username": request.session.get("user_info").get("name")})
...
def depart_edit(request, nid):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'depart_edit.html', {'form': form, "username": request.session.get("user_info").get("name")})
