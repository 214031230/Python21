# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-08-31 12:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classify', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fault_reporting.Classify', verbose_name='分类')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='fault',
            name='tags',
            field=models.ManyToManyField(to='fault_reporting.Tag', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='fault',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='fault',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fault_reporting.Fault', verbose_name='报障内容'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
